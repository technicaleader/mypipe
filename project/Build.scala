...
object Dependencies {
  ...
  val kafka = "org.apache.kafka" % "kafka_2.10" % "0.8.2.2" exclude("javax.jms", "jms") exclude("com.sun.jdmk", "jmxtools") exclude("com.sun.jmx", "jmxri") exclude("org.slf4j", "slf4j-log4j12")
  val logback = "ch.qos.logback" % "logback-classic" % "1.1.2" force()
  val slf4jApi = "org.slf4j" % "slf4j-api" % "1.7.12" force()
  val mysqlAsync =  "com.github.mauricio" % "mysql-async_2.10" % "0.2.18"
